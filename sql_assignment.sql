## TASK 1
# This database contains details of transactions of superstore. 
# and has 5 tables 1. cust_dimen (containing details about 
# customer and their respective locations) 2. prod_dimen (containing 
# product category and their subcategories)3.  orders_dimen (with order no,
# date, and priority)4. shipping_dimen (with ship date, order and shipping 
# mode) 5. market_fact (orderwise customerwise marketwise orderquantity, 
# sales value, discount profit and shipping cost details).

# We can derive information from the market table having the cust_ID, prod_ID and orderID 
#which can act as a foreign key.
